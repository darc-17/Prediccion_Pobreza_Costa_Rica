...
Proyecto de clasificación binaria desarrollado para el **Banco Interamericano de Desarrollo (BID)** con el objetivo de mejorar el sistema de focalización de subsidios sociales en Costa Rica, reemplazando el *Proxy Means Test* (PMT) vigente.
